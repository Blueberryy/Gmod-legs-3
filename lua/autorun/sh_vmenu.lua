	...
	list.Set( "DesktopWindows", "GmodLegsEditor", 
    {
        ...
        init        = function( icon, window )
            ...
            window.Paint = function()
                ...
                draw.SimpleText("#gml3_menu_title", "coolvetica28", 4, 15, Color(255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)    
            end
...
/*
			...
			tabs:AddSheet("#gml3_button_other_addons", addons, "icon16/add.png"   )
*/				
        end
    } )
end	